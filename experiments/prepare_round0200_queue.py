#!/usr/bin/env python3
"""Prepare, but never launch, final authority-corrected Track F1 R0200."""
...
from basemap.round0200_grease_batch_stable import CAPABILITY, ROUND_ID
...
from experiments.round0200_nodes import __file__ as NODE_SCRIPT


ROUND_ROOT = "/data/latent-basemap/runs/round-0200"
QUEUE_ROOT = os.path.join(ROUND_ROOT, "queue")
RELEASE_ROOT = "/home/enjalot/code/latent-basemap-cpu-run"
ROUND_FILE = os.path.join(LAB_ROOT, "round-0200-2026-08-05.md")
...
def _issued_round(release_sha: str) -> dict[str, Any]:
    ...
    if (
        ...
        or _frontmatter_list(frontmatter, "supersedes") != ["0199"]
        or _frontmatter_list(frontmatter, "required_reviews") != ["0181"]
    ):
        raise RuntimeError("R0200 is not the issued final R0196/R0199 replacement")
    return expected_input_signature(ROUND_FILE)


def prepare_round0200(*, release_sha: str, queue_root: str = QUEUE_ROOT) -> str:
    if not re.fullmatch(r"[0-9a-f]{40}", release_sha):
        raise ValueError("R0200 release SHA must be one full commit")
    ...
    queue_root = create_fresh_directory(queue_root, label="R0200 CPU queue")
    ...
    job = {
        ...
        "handler_module": "experiments.round0200_nodes",
    ...
    queue.update({
        "schema": "round0200-grease-batch-stability-diagnosis-queue-v1",
        ...
        "scientific_contract": {
            ...
            "supersedes_round": "0199",
            "correction_chain": ["0196", "0199", "0200"],
            "correction": "queue authority and parsed supersession lineage now match the issued contract",
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(json.dumps({
        "queue_manifest": prepare_round0200(
