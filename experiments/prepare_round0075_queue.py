#!/usr/bin/env python3
"""Prepare the coverage-aligned balanced-90M training queue."""
...
from experiments.round0075_nodes import _load_evidence


ROUND_ROOT = "/data/latent-basemap/runs/round-0075"
RELEASE_ROOT = "/home/enjalot/code/latent-basemap-run"
ROUND_FILE = os.path.join(
    LAB_ROOT,
    "round-0075-2026-07-27.md",
)
...
def _require_issued_round() -> None:
    if _frontmatter_status(ROUND_FILE) != "issued":
        raise RuntimeError("R0075 remains draft; refuse queue materialization")


def prepare_round0075(
    *,
    release_sha: str,
    scale_geometry_path: str,
    scale_geometry_sha256: str,
    anchor_leverage_path: str,
    ...
    r0073_review_path: str,
    r0073_review_sha256: str,
    ...
    if not re.fullmatch(r"[0-9a-f]{40}", release_sha):
        raise ValueError("R0075 release SHA must be one full commit")
    evidence_job = {
        "scale_geometry": scale_geometry_path,
        "scale_geometry_sha256": scale_geometry_sha256,
        "anchor_leverage": anchor_leverage_path,
        "anchor_leverage_sha256": anchor_leverage_sha256,
    }
    scale_signature, anchor_signature = _load_evidence(evidence_job)
    ...
    reviews = {
        ...
        "0073": _require_review(
            r0073_review_path,
            expected_sha256=r0073_review_sha256,
            required_text=(
                "capability:minilm-balanced-90m-gpu-native-graph-v1",
    ...
    queue_root = create_fresh_directory(
        queue_root,
        label="Round 0075 GPU queue",
    )
    artifacts = ensure_data_directory(os.path.join(queue_root, "artifacts"))
    output = os.path.join(artifacts, "train-balanced-90m")
    inputs = _dedupe(_file_inputs([
        ROUND_FILE,
        scale_geometry_path,
        anchor_leverage_path,
        substrate_manifest_path,
    ...
    manifest["schema"] = "round0075-balanced-90m-train-queue-v1"
    ...
    manifest["jobs"] = [{
        "id": "train_seed42_balanced_90m",
        "action": "train_balanced_90m",
        "handler_module": "experiments.round0075_nodes",
        "handler_callable": "run_job",
        "deps": [],
        "outputs": [output],
        "done_marker": os.path.join(
            artifacts,
            "train_seed42_balanced_90m.done.json",
        ),
    ...
    manifest["p90_gpu_seconds"] = {
        "train_seed42_balanced_90m": p90_seconds,
        "total": p90_seconds,
    }
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--anchor-leverage", required=True)
    ...
    for round_id in ("0069", "0071", "0073", "0074"):
    ...
    print(json.dumps({
        "queue_manifest": prepare_round0075(
            ...
            r0073_review_path=args.r0073_review,
            r0073_review_sha256=args.r0073_review_sha256,
            r0074_review_path=args.r0074_review,
            r0074_review_sha256=args.r0074_review_sha256,
