...
def validate_arm(arm):
 ...
 assert m['exposure']==validate_exposure(m['train_stats']);assert m['support_fractions']==fractions(m['exposure']);assert m['lmc_stats'] is None;assert m['pipeline_info']['weighted_requested'] is True and m['pipeline_info']['weighted_effective'] is True and m['pipeline_info']['positive_sampling']=='weighted_with_replacement'
