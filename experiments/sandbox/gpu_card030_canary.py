import json,shutil
import torch
from run_card030_arm import fit,OUT,OC,ROOT,sha,write
...
def main():
 ...
 validate_resume_payload(ck,120)
 ...
 write(OC/'card030-gpu-canary.json',r);print(json.dumps({'PASS':r['PASS'],'checks':checks},indent=2));assert r['PASS']
