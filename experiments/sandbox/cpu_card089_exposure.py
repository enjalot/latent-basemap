...
def main():
 ...
 C.write(C.O/'card089-exposure-cpu.json',{'PASS':True,'checks':checks,'exposure':e,'support_fractions':fractions,'scope':'Actual CPU GradScaler overflow on both short tails; durable stats serialization at mid/epoch; unchanged model/Adam/scaler/sampler versus instrumentation off. Actual device full-state twins remain required.'});print('EXPOSURE PASS',len(checks),e)
