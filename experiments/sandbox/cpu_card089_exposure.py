...
from card089_exposure import observe,validate,fractions as support_fractions
...
def main():
 ...
 fractions=support_fractions(e);assert fractions['attempted']['reciprocal']==e['attempted_reciprocal_slots']/15360 and fractions['successful']['reciprocal']==e['successful_reciprocal_slots']/13104 and fractions['attempted']!=fractions['successful'];checks['actual_attempted_successful_fractions_distinct']=True
 for k in [2,5]:
 ...
 C.write(C.O/'card089-observer-readiness/exposure-contracts.json',{'PASS':True,'checks':checks,'exposure':e,'support_fractions':fractions,'scope':'Actual CPU GradScaler overflow on both short tails; durable stats serialization at mid/epoch; unchanged model/Adam/scaler/sampler versus instrumentation off. Actual device full-state twins remain required.'});print('EXPOSURE PASS',len(checks),e)
