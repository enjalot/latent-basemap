...
def validate_arm(arm):
 ...
 if arm=='lmc':
  ls=m['lmc_stats'];assert ls and ls['weight']==.02 and ls['attempted_calls']>=C.DOSE-m['resume_start_step'] and ls['invalid_variance_calls']<ls['attempted_calls'],'no valid landmark exposure'
