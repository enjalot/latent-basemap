...
C.write(C.O/'card061-cpu-canary.json',{'PASS':True,'n_checks':len(checks),'checks':checks,'scope':'Kernel formulas, grouping and original059 outputs; no new query or GPU outcome.'});print('PASS',len(checks))
