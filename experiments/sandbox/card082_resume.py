from card082_common import N,BATCH,SEED,LR
POS_RATIO=.1
def validate_resume_payload(ck, step, n_nodes=None):
    ...
    assert ident.get("fneg_weight") in (0.,1.) and ident.get("neg_tanh_gamma") in (0.,4.) and ident.get("positive_target_mode")=="binary", "negative/positive recipe identity drift"
