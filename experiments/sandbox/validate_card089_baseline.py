...
def main():
 ...
 assert C.sha(root/'card086-runtime-sha.json')==C.read(C.O/'card089-final-readiness/runtime-contracts.json')['baseline_runtime_sha'],'baseline runtime changed since CPU review'
