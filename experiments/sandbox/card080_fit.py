...
def validate_arm(arm):
 ...
 model=torch.load(dest/'model.pt',map_location='cpu',weights_only=False);assert model['rankneg_window']==ident['rankneg_window'] and model['fneg_weight']==1. and model['neg_tanh_gamma']==4.
