...
with tempfile.TemporaryDirectory(dir=C.R.parent,prefix='card088-graph-canary-') as path:
 ...
 for arm in C.ARMS:
  ...
  for tag,override in [('arm',{'arm':'wrong'}),('warm',{'warm_sha':'0'*64}),('scale',{'scale_manifest_sha':'0'*64}),('dimension',{'output_dim':8}),('learning_rate',{'lr':.00037}),('policy',{'rankneg_window':123}),('dose',{'dose':19}),('graph',{'graph_sha':'0'*64}),('weights',{'weight_values_sha':'0'*64}),('weighted_flag',{'weighted_edge_sampling':False}),('reference',{'reference_sha':'0'*64}),('data',{'data_manifest_sha':'0'*64}),('parent',{'parent_sha':'0'*64}),('law',{'positive_support_law':[1,1]}),('logical_epoch',{'logical_epoch_draws':123}),('cdf_side',{'cdf_side':'left'}),('columns',{'endpoint_columns':15}),('endpoints',{'endpoints_sha':{'sources':'bad','targets':'bad'}})]:
