"""CUDA-hidden node-receipt -> finalizer -> reload smoke for R0139."""
...
def test_post_embedding_receipts_finalize_without_cuda(
    ...
    assert result["source_order"] == ["hin_Deva", "ind_Latn", "ita_Latn"]
    ...
    contract.validate_seal(
        ...
        label="R0139 CPU smoke final manifest",
    )
    ...
    contract.validate_seal(
        published, label="reloaded R0139 CPU smoke final manifest"
    )
