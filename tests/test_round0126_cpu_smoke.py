"""CUDA-hidden node-receipt -> finalizer -> reload smoke for R0126."""
...
def test_post_embedding_receipts_finalize_without_cuda(
    ...
    assert result["source_order"] == ["arb_Arab", "ces_Latn", "cmn_Hani"]
    ...
    contract.validate_seal(
        ...
        label="R0126 CPU smoke final manifest",
    )
    ...
    contract.validate_seal(
        published, label="reloaded R0126 CPU smoke final manifest"
    )
