"""CUDA-hidden node-receipt -> finalizer -> reload smoke for R0141."""
...
def test_post_embedding_receipts_finalize_without_cuda(
    ...
    assert result["source_order"] == ["jpn_Jpan", "kor_Hang", "nld_Latn"]
    ...
    contract.validate_seal(
        ...
        label="R0141 CPU smoke final manifest",
    )
    ...
    contract.validate_seal(
        published, label="reloaded R0141 CPU smoke final manifest"
    )
