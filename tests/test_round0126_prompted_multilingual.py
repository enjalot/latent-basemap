"""CUDA-hidden contract, encoder, and preparer tests for R0126."""
...
from basemap import round0126_prompted_multilingual as contract
from basemap.artifact_identity import expected_input_signature
from experiments import prepare_round0126_queue as prepare
from experiments import round0126_nodes as nodes
...
def test_registered_tranches_and_budget_close_exactly() -> None:
    ...
    assert [item["r0087_global_row_range"] for item in contract.LANGUAGE_TRANCHES] == [
        [9_126_376, 9_961_830],
        [9_961_830, 10_797_284],
        [10_797_284, 11_632_738],
    ]
...
def test_source_layout_binds_exact_r0087_rows_and_both_byte_streams(
    ...
    with pytest.raises(contract.Round0126Error, match="malformed"):
...
def test_boundary_rehash_rejects_mutated_large_input_equivalent(tmp_path) -> None:
    ...
    with pytest.raises(contract.Round0126Error, match="bytes changed"):
...
def test_preparer_materializes_three_independent_gpu_nodes_and_cpu_finalizer(
    ...
    round_file = tmp_path / "round-0126.md"
    ...
    queue_path = prepare.prepare_round0126(
        release_sha="a" * 40,
