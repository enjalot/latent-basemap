"""Fixed balanced-120M GPU candidate-search qualification contract."""
...
QUALIFICATION_SCHEMA = (
    "round0077-balanced-120m-gpu-ivfpq-qualification-v1"
)
NPROBE_GRID = (16, 24, 32, 40, 48, 64, 96, 128)
MEAN_RECALL_FLOOR = 0.90


class Round0077Error(RuntimeError):
    """The balanced-120M search-qualification contract was violated."""
...
def load_gpu_qualification(
    ...
    *,
    ...
    """Authenticate the exact R0077 policy and filtered-index capability."""
    signature = expected_input_signature(path)
    if signature["sha256"] != expected_sha256:
        raise Round0077Error("R0077 qualification bytes changed")
    ...
    if (
        ...
        raise Round0077Error("R0077 qualification identity changed")
