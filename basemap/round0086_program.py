"""Content-bound balanced-150M substrate validation."""
...
class Round0086Error(RuntimeError):
    """The registered balanced-150M substrate contract was violated."""
...
def validate_substrate(
    ...
    *,
    ...
    if any(
        ...
        for key, value in EXPECTED_ELIGIBILITY_SUMMARY.items()
    ):
