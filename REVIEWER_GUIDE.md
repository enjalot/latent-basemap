...
- The exact R0265-R0268 production modules are on branch
  `basemap-100m/round-0208` at release `d3ac5c4`. This publication branch and the
  research branch diverged, so line-level review of the final trainer should use
  that release.
...
- Reconcile the publication and research branches into a reviewable release tag.
